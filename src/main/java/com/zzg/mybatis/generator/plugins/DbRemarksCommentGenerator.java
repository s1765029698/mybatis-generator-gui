...
public class DbRemarksCommentGenerator implements CommentGenerator {
    ...
    public void addModelClassComment(TopLevelClass topLevelClass,
        ...
        topLevelClass.addJavaDocLine(" * " + StringUtils.trimToEmpty(introspectedTable.getRemarks()));
        ...
        topLevelClass.addAnnotation("@ApiModel(\"" + this.getEntityName(introspectedTable.getRemarks()) + "\")");
    }

    private String getEntityName(String tableRemarks){
        if(StringUtils.isNotBlank(tableRemarks)){
            String[] strings = tableRemarks.split("[ ：:-]");
            if(strings.length > 0){
                return strings[0];
            }
        }
